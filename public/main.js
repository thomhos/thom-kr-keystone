...
/***/ function(module, exports, __webpack_require__) {
	...
	var _headerMain = __webpack_require__(300);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _initClass = __webpack_require__(301);

	var _initClass2 = _interopRequireDefault(_initClass);
	...
	var HeaderMain = function () {
		function HeaderMain(element) {
			var _this = this;

			_classCallCheck(this, HeaderMain);

			this.onBurgerClick = function (event) {
		...
		_createClass(HeaderMain, [{
			...
			value: function toggleMenu() {
				var menuState = this.burger.classList.contains('is-active');
	...
	(0, _initClass2.default)('.header__main', HeaderMain);
...
/***/ function(module, exports) {
	...
	exports.default = function (selector, constructor, opt_arguments) {
